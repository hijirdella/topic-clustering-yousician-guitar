...
kmeans_model = joblib.load("YousicianGuitar_clustering.pkl")
tfidf_vectorizer = joblib.load("YousicianGuitar_tfidf_vectorizer.pkl")

# === Set Halaman ===
st.set_page_config(page_title="Topic Clustering - Yousician: Guitar & Bass", layout="wide")

# === Judul Aplikasi dengan Emoji Gitar 🎸 ===
st.title("🎸 Topic Clustering - Yousician: Guitar & Bass")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_yousician_guitar.csv",
                mime="text/csv"
            )
